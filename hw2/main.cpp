...
public:
    ...
    void run()
    {
        ...
        address = SocketAddress("192.168.93.169", 8000);
...
private:
    ...
    {   
        ...
        while (sample_num < 400)
        {
            ...
            char acc_json[600];
            int delay = 100;
            float _x = pGyroDataXYZ[0],
            _y = pGyroDataXYZ[1],
            _z = pGyroDataXYZ[2];
            int len = sprintf(acc_json,
            "{\"ACCELERO_X\":%f, \"ACCELERO_Y\":%f, \"ACCELERO_Z\":%-f, \"GYRO_X\":%.2f, \"GYRO_Y\":%.2f, \"GYRO_Z\":%.2f, \"s\":%-5d}",
            (float)((int)(x*10000))/10000,(float)((int)(y*10000))/10000, (float)((int)(z*10000))/10000, _x, _y, _z, sample_num);
